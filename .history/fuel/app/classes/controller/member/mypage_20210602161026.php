...
class Controller_Member_Mypage extends Controller_Member
{
    public function action_index()
    {
        ...
        // GETパラメータを取得
        $get_month = Input::get('current_month');
        Log::debug(print_r($get_month, true));
        $current_year = date('Y');
        $current_month = date('-m', strtotime($current_year.'-06-01'));
        $month_count = date('t', strtotime($current_year.$current_month.'-01'));
